...
class ExtendedFunctions():
    def __init__(self):
        ...
        self.my_dll = 'C:/Users/donal/source/repos/LiDAR_Lib/x64/Debug/LiDAR_Lib.dll'
        self.myLiDAR = cdll.LoadLibrary(self.my_dll)

    #Start the Sensor
    def Start_Sensor(self):
        port = c_char_p("\\\\.\\com3")
        if (self.myLiDAR.BeginSensor(port) == 1):
            return True
        else:
            return False
...
class HLS_Functions():
    ...
    # /////////////////////////////////////////////////// MONTE CARLO //////////////////////////////////////////////////////
    def HLS_distance(self, scan, mp, pos):
        nb_points = 0
        posx = pos[0]
        posy = pos[1]
        postheta = pos[2]
    ...
    def HLS_Monte_Carlo(self, scan, mp, pos):
        counter = 0
        curpos = pos[:]
        bestpos = pos[:]
        lastbestpos = pos[:]
        currentdist = hls_func.HLS_distance(scan, mp, curpos)
    ...
    def HLS_map_laser_ray(self, mp, x1, y1, x2, y2, xp, yp, value, alpha):
    ...
    def HLS_map_update(self, scan, mp, ipos, quality):
        posx = ipos[0]
        posy = ipos[1]
        postheta = ipos[2]
        ...
        for i in range(0, (int(scan[0][0]))):
            ...
            self.HLS_map_laser_ray(mp, x1, y1, x2, y2, xp, yp, value, q)
...
if(functions.Start_Sensor() == True):
    try:
        ...
        while (go == True):
            ...
            # print("Monte Carlo....")
            pos2 = hls_func.HLS_Monte_Carlo(scaner, mp, pos)
            ...
            # print("Map Update.....")
            mp = hls_func.HLS_map_update(scaner, mp, pos, 50)
    ...
    #Wait to allow for C Messages to finish
    cv2.waitKey(50)
